...
//  Moozy_App
//
//  Created by Toseef Ahmed on 15/06/2022.
//
...
class AKAudioRecorder: NSObject {
    ...
    //    /var/mobile/Containers/Data/Application/A9651C7D-599D-4854-B30F-80FEF86DDA02/Documents/Audios/Audio_1655295688920392.m4a
        let fileName =   pat      //name + ".Audios"
        print(fileName)
    ...
    func deleteRecordingfromtable(name: String){
          do {
