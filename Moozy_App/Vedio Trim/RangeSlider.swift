...
class RangeSlider: UIControl {
    ...
    func updateLayerFrames() {
        ...
        lowerThumbLayer.frame = CGRect(x: lowerThumbCenter - thumbWidth/2.0, y: -5.0, width: thumbWidth, height: 60)
        lowerThumbLayer.setNeedsDisplay()
        
        let upperThumbCenter = CGFloat(positionForValue(upperValue))
        upperThumbLayer.frame = CGRect(x: upperThumbCenter - thumbWidth/2.0, y: -5.0, width: thumbWidth, height: 60)
        upperThumbLayer.setNeedsDisplay()
